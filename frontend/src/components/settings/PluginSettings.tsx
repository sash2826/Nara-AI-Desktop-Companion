    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-0.5 text-xs text-muted-foreground">
          ...
          <code className="font-mono">%APPDATA%\Document-Management-RAG-Graph-Agent\plugins\</code>{" "}
          and restart the application to register it.
        </p>
      </div>
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              ...
              <code className="font-mono">
                %APPDATA%\Document-Management-RAG-Graph-Agent\plugins\
              </code>{" "}
              and restart.
            </p>
          </div>
