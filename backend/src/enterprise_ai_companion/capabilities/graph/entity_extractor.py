...
_SYSTEM_PROMPT: str = (
    ...
    "}\n\n"
    "Rules:\n"
    "- Include proper nouns AND domain-specific technical terms, processes, systems, and\n"
    "  methodologies (e.g. 'depot charging', 'warehouse slotting', 'carbon footprint',\n"
    "  'occupancy analytics', 'preventive maintenance', 'duty of care').\n"
    "- Omit single generic words that appear in any document: 'data', 'report', 'system',\n"
    "  'management', 'process', 'plan', 'analysis', 'review', 'strategy', 'solution'.\n"
    "- Prefer compound domain terms over bare single words (e.g. 'load forecasting' over 'load').\n"
